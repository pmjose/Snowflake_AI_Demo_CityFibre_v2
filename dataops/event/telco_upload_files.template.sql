-- ============================================================================
-- CityFibre UK AI Demo - Upload Files to Stages (DataOps Template)
-- ============================================================================
...
-- Upload all CityFibre UK demo CSV data files (dimensions, facts, salesforce tables)
...
-- ============================================================================
-- Step 2: Upload CityFibre UK Unstructured Documents to DATA_STAGE/unstructured_docs/
-- ============================================================================

-- Upload CityFibre UK finance/strategy/network/sales/marketing/HR docs (markdown)
...
-- Optional: upload CityFibre UK / Liberty Global reports (provide your own files)
-- Example:
-- PUT 'file://{{ env.CI_PROJECT_DIR }}/reports/FY24-Trading-Update-FINAL2100225.pdf' @DATA_STAGE/unstructured_docs/finance/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
