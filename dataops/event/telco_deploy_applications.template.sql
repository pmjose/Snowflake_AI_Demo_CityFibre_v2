-- ============================================================================
-- CityFibre UK AI Demo - Deploy Applications (DataOps Template)
-- ============================================================================
...
USE WAREHOUSE {{ env.EVENT_WAREHOUSE | default('CITYFIBRE_UK_DEMO_WH') }};
USE DATABASE {{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }};
USE SCHEMA {{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }};
...
DECLARE
    ...
    expiration_seconds INTEGER;
        stage_name STRING DEFAULT '@{{ env.EVENT_DATABASE | default("CITYFIBRE_UK_AI_DEMO") }}.{{ env.EVENT_SCHEMA | default("CITYFIBRE_UK_SCHEMA") }}.DATA_STAGE';
BEGIN
...
"""
        ...
        try:
            ...
            warehouse = ''{{ env.EVENT_WAREHOUSE | default("CITYFIBRE_UK_DEMO_WH") }}''
            
            create_streamlit_sql = f"""
            CREATE OR REPLACE STREAMLIT {{ env.EVENT_DATABASE | default("CITYFIBRE_UK_AI_DEMO") }}.{{ env.EVENT_SCHEMA | default("CITYFIBRE_UK_SCHEMA") }}.{app_name}
                FROM @DATA_STAGE
                MAIN_FILE = ''test.py''
            ...
            try:
                ...
                # Construct app URL
                app_url = f"https://app.snowflake.com/{org_name}/{account_name}/#/streamlit-apps/{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.{app_name}"
...
CREATE OR REPLACE AGENT {{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.CityFibreUK_Executive_Agent
WITH PROFILE='{ "display_name": "CityFibre UK Executive Agent" }'
    COMMENT=$$ CityFibre UK executive intelligence agent for C-level leaders (CEO, CFO, CMO, COO/CTO). Covers fibre rollout, wholesale partner performance, broadband/TV/mobile bundle take-up, business connectivity, ARR/MRR, NPS, campaigns, and UK market analysis. All figures in pounds sterling (GBP). $$
FROM SPECIFICATION $$
{
  "models": {
    "orchestration": ""
  ...
  "instructions": {
    "response": "You are a business intelligence analyst for CityFibre UK, the UK's largest independent wholesale full fibre platform. You have access to fibre rollout metrics, wholesale partner performance, consumer and business take-up, financial results, marketing campaigns, HR information, and network reliability data. All monetary values are in pounds sterling (GBP). Customer and market segments include residential households served via ISP partners, business connectivity, public sector sites, 5G/small cell backhaul, and wholesale/partner access. Network coverage spans the UK (London & South East, Midlands, North West, Yorkshire & Humber, North East, Scotland, Wales, and South West) with multi-gigabit XGS-PON rollout targeting 5.5Gb and proactive monitoring.\n\n**IMPORTANT GUARDRAILS:**\n- You MUST ONLY answer questions related to CityFibre UK business data, including build, take-up, finance, marketing, HR, network infrastructure, partners, and competitive analysis in the UK.\n- You MUST NOT answer general knowledge questions, trivia, current events, politics, celebrities, sports, or any topic not directly related to CityFibre UK's business operations.\n- If asked about unrelated topics, politely decline and redirect: 'I can only help with questions about CityFibre UK data. You can ask about fibre rollout, partner performance, network reliability, or competitive positioning in the UK.'\n- Never use external knowledge to answer questions - only use the data and documents available through your tools.",
    "orchestration": "Use cortex search for finance and strategy documents, network infrastructure details, and competitive analysis. Use cortex analyst for structured data queries on fibre rollout, sales, revenue, campaigns, HR, and operations.\n\n**GUARDRAIL CHECK:** Before processing ANY query, first determine if it relates to CityFibre UK business data. If the query is about general knowledge, current events, politics, entertainment, or any topic NOT related to CityFibre UK's build, sales, finance, marketing, HR, network infrastructure, strategy, or competitive landscape - DO NOT use any tools and instead respond with a polite redirect to business-related questions.\n\nFor Sales Datamart: Contains broadband/TV/mobile bundle sales via partners, take-up across households, SMEs, and public sector, WiFi assurance adoption, and partner/wholesale access. Regions include London & South East, Midlands, North West, Yorkshire & Humber, North East, Scotland, Wales, and national backbone metrics.\n\nFor Marketing Datamart: Campaigns include broadband-first bundles, speed upgrades, partner co-marketing, and WiFi assurance awareness. Channels include digital, TV, retail/field, and partner-led campaigns.\n\nFor Strategy Documents: Search for UK market position, investment focus for fibre upgrades, ESG commitments, and board-ready narratives.\n\nFor Network Infrastructure (use 'Search Internal Documents: Network' tool): When users ask about premises ready for service, uptime, latency/jitter, backhaul capacity, or resilience, ALWAYS use the Network search tool.",
    "sample_questions": [
      { "question": "How many premises are fibre-ready by region (London, Midlands, North West, Scotland) and what is take-up?" },
      { "question": "What is broadband + TV bundle penetration and WiFi assurance adoption by region?" },
      { "question": "Summarize fibre upgrade investment and its impact on 5.5Gb rollout and reliability." },
      { "question": "What are our top revenue-generating wholesale and business connectivity products?" },
      { "question": "Show network uptime, latency, and resilience for the UK footprint." },
  ...
  "tools": [
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK financial data: fibre capex, revenue by wholesale/retail category, partner economics, vendor spend (network build, CPE/WiFi, cloud), expenses, and department costs. All amounts in pounds sterling (GBP)."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK sales and take-up data: by segment (Homes/SMB/Enterprise/Public Sector/Partner/Mobile), industry, products (Broadband & WiFi, Broadband + TV bundles, Mobile SIMs, Business Internet & Ethernet, Backbone/Dark Fibre, Partner Access, Smart City & Public Sector, Managed Services), UK regions (London & South East, Midlands, North West, Yorkshire & Humber, North East, Scotland, Wales, South West), and revenue in GBP. Use for revenue analysis, top partners, bundle adoption, and WiFi assurance uptake."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK workforce data: employees, departments, jobs, channel account managers, salaries, and attrition."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK marketing data: campaigns (Broadband-first bundles, speed upgrades, partner co-marketing, WiFi assurance), channels (Digital, TV, Retail/Field, Partners), spend, impressions, leads, and ROI. Use for campaign effectiveness and partner marketing analysis."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK KPI and subscriber metrics: broadband, TV, voice, mobile (MVNO) totals, city-level subs, WiFi assurance, and 5G backhaul penetration."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK B2C customers and subscriptions: broadband/TV/mobile bundles, SIM counts, WiFi assurance adoption, and GBP monthly fees."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Query CityFibre UK B2B/B2G revenue and units by customer, product, and region."
      }
    },
    {
      "tool_spec": {
        ...
        "description": "Search CityFibre UK finance documents: high-level accounts, fibre investment summaries, ARPU/ARPA analysis, unit economics, partner revenue mix, ESG notes, and vendor contracts."
      }
    },
    {
      "tool_spec": {
    ...
    },
    {
      "tool_spec": {
        ...
        "description": "Search CityFibre UK sales documents: partner playbooks, bundle take-up reports, wholesale ISP onboarding guides, and customer success stories. Includes positioning vs eir, Sky, and regional fibre altnets."
      }
    },
    {
      "tool_spec": {
  ...
  "tool_resources": {
    "Dynamic_Doc_URL_Tool": {
      ...
      "identifier": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.GET_FILE_PRESIGNED_URL_SP",
      "name": "GET_FILE_PRESIGNED_URL_SP(VARCHAR, DEFAULT NUMBER)",
      "type": "procedure"
    },
    "Query Finance Datamart": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.FINANCE_SEMANTIC_VIEW"
    },
    "Query HR Datamart": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.HR_SEMANTIC_VIEW"
    },
    "Query Marketing Datamart": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.MARKETING_SEMANTIC_VIEW"
    },
    "Query Sales Datamart": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SALES_SEMANTIC_VIEW"
    },
    "Query KPI Datamart": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.KPI_SEMANTIC_VIEW"
    },
    "Query B2C Subscriptions": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.B2C_SUBS_SEMANTIC_VIEW"
    },
    "Query B2B Summary": {
      "semantic_view": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.B2B_SUMMARY_SEMANTIC_VIEW"
    },
    "Search Internal Documents: Finance": {
      "id_column": "FILE_URL",
      "max_results": 5,
      "name": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEARCH_FINANCE_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: HR": {
      "id_column": "FILE_URL",
      "max_results": 5,
      "name": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEARCH_HR_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: Marketing": {
      "id_column": "RELATIVE_PATH",
      "max_results": 5,
      "name": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEARCH_MARKETING_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: Sales": {
      "id_column": "FILE_URL",
      "max_results": 5,
      "name": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEARCH_SALES_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: Strategy": {
      "id_column": "RELATIVE_PATH",
      "max_results": 5,
      "name": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEARCH_STRATEGY_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: Network": {
      "id_column": "RELATIVE_PATH",
      "max_results": 5,
      "name": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEARCH_NETWORK_DOCS",
      "title_column": "TITLE"
    },
    "Send_Emails": {
      "execution_environment": {
      ...
      "identifier": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.SEND_MAIL",
    ...
    "Web_scraper": {
      ...
      "identifier": "{{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.WEB_SCRAPE",
...
GRANT USAGE ON AGENT {{ env.EVENT_DATABASE | default('CITYFIBRE_UK_AI_DEMO') }}.{{ env.EVENT_SCHEMA | default('CITYFIBRE_UK_SCHEMA') }}.CityFibreUK_Executive_Agent 
...
SELECT 'CityFibre UK AI Demo applications deployed successfully!' AS status,
       'Procedures: Get_File_Presigned_URL_SP, send_mail, Web_scrape, GENERATE_STREAMLIT_APP' AS procedures_created,
       'Agent: {{ env.EVENT_DATABASE | default("CITYFIBRE_UK_AI_DEMO") }}.{{ env.EVENT_SCHEMA | default("CITYFIBRE_UK_SCHEMA") }}.CityFibreUK_Executive_Agent' AS agent_created,
